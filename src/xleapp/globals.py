...
from xleapp import VERSION as __version__  # noqa N811
from xleapp._authors import __authors__
...
def set_output_folder(output_folder) -> tuple:
    ...
    report_folder = Path(output_folder) / f"xLEAPP_Reports_{current_time}"
