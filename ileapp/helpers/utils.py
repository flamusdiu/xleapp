...
import ileapp.helpers.strings as istrings
from ileapp.report.templating import Template
...
def ValidateInput(input_path: str,
                  output_path: str,
                  selected_artifacts: list,
                  core_artifacts_only: bool = False) -> Union[str, str]:
    """
...
def get_abstract_artifact():
    module = importlib.import_module('ileapp.abstract')
